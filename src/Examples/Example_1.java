...
public class Example_1 {
    public static void main(String[] args) {
        try{
            ...
            //Создание корневого эллемента (Основного блока так сказать)
            Document doc = docBuilder.newDocument();
            Element rootElement = doc.createElement("library");
            doc.appendChild(rootElement);
            //Добавление первой книги (И собираем внутри все как матрёшку)
            ...
            // Я так понимаю, выше был скомпанован объект doc. Но это еще не XML
            //Далее этот объект необходимо преобразовать в XML и создать файл
            //Запись XML
            ...
            javax.xml.transform.stream.StreamResult result =
                    new javax.xml.transform.stream.StreamResult(new File("src\\Examples\\example_1.xml"));
